...
namespace GMIS.Migrations
{
    ...
    [Migration("20190329091833__projectInfoss")]
    partial class _projectInfoss
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GMIS.Entity.Project", b =>
                {
                    b.HasOne("GMIS.Entity.ProjectInformation.ProjectInfo", "ProjectInfo")
                        .WithOne("Project")
                        .HasForeignKey("GMIS.Entity.Project", "ProjectInfoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
